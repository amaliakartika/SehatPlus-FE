...
const PilihJadwalDokter = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-[92vh] gap-4 mt-8">
      ...
      <div className="flex flex-col justify-center  w-[70vw] h-[80vh] md:w-[60vw] md:h-[70vh] lg:w-[60vw] lg:h-[90vh] xl:w-[40vw] xl:h-[90vh] bg-blue-100 rounded-xl px-5">
