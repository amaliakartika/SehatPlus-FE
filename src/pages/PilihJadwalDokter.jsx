...
const PilihJadwalDokter = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-[98vh] gap-4 mt-[8rem]">
      ...
      <div className="flex flex-col justify-center  w-[70vw] h-[80vh] md:w-[60vw] md:h-[70vh] lg:w-[60vw] lg:h-[95vh] xl:w-[40vw] xl:h-95vh] bg-blue-100 rounded-xl px-5 mb-[6rem]">
