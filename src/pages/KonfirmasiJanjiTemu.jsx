...
const KonfirmasiJanjiTemu = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-[100vh] gap-4 mt-[8rem]">
      ...
      <div
        className="flex flex-col justify-center  w-[70vw] h-[50vh] md:w-[60vw] md:h-[65vh] lg:w-[50vw] lg:h-[95vh] xl:w-[
