...
const KonfirmasiJanjiTemu = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-[100vh] gap-4 mt-[10rem]">
      ...
      <div
        className="flex flex-col justify-center  w-[70vw] h-[75vh] md:w-[60vw] md:h-[65vh] lg:w-[50vw] lg:h-[100vh] xl:w-[
        40vw] xl:h-[100vh] bg-blue-100 rounded-xl px-5 mb-[8rem]"
      >
